...
class Settings(BaseSettings):
    ...
    INTERVIEW_BROWSER_JOIN_TIMEOUT_SEC: int = 180
    INTERVIEW_CANDIDATE_WAIT_TIMEOUT_SEC: int = 900
    INTERVIEW_STT_TURN_TIMEOUT_SEC: int = 135
    INTERVIEW_LLM_GENERATION_TIMEOUT_SEC: int = 60
    INTERVIEW_TTS_PLAYBACK_TIMEOUT_SEC: int = 120
    INTERVIEW_ANALYSIS_TIMEOUT_SEC: int = 300
    INTERVIEW_CLEANUP_TIMEOUT_SEC: int = 20
