# app/services/interview/utils/constants.py
...
class AudioConfig:
    ...
    VOLUME_THRESHOLD: Final[float] = 0.005        # Minimum volume to detect speech
...
class ServiceConfig:
    ...
    STT_VALID_REGIONS: Final[Tuple[str, ...]] = ("us", "eu", "global")
...
class StoragePaths:
    ...
    CAPTURED_IMAGES_DIR: Final[str] = "captured_frames"
