...
# app/services/interview/audio/audio_handler.py
"""
...
from app.config.constants import AudioConfig
        ...
        def feeder_func(audio_queue: queue.Queue, finished: threading.Event):
            ...
            try:
                ...
                try:
                    ...
                    logger.error(f"Corrupted audio file detected: {file_path}. Deleting...")
                    try:
